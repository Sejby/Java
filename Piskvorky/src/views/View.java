...
public class View extends javax.swing.JFrame {
    ...
    public View() {
        initComponents();
        platno1.setSize(Nastaveni.pocetPolicek*Nastaveni.velikostPole,Nastaveni.pocetPolicek*Nastaveni.velikostPole);
        platno1.setPreferredSize(new Dimension(Nastaveni.pocetPolicek*Nastaveni.velikostPole+1,Nastaveni.pocetPolicek*Nastaveni.velikostPole+1));
    }
    ...
    private void initComponents() {
        ...
        platno1 = new views.Platno();

        setDefaultCloseOperation(javax.swing.WindowConstants.EXIT_ON_CLOSE);
        setTitle("Buriánkovy úžasné piškvorky");
        setResizable(false);
